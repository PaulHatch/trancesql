...
namespace TranceSql.Language
{
    ...
    public class Any<T1, T2>
    {
        ...
        /// <summary>
        /// Performs an implicit conversion from <see cref="T1"/> to <see cref="Any{T1, T2}"/>.
        /// </summary>
        ...
        /// <summary>
        /// Performs an implicit conversion from <see cref="T2"/> to <see cref="Any{T1, T2}"/>.
        /// </summary>
        /// <param name="value">The value.</param>
        /// <returns>
        /// The result of the conversion.
        ...
        where T2 : TRoot
    {
        ...
        /// <summary>
        /// Performs an implicit conversion from <see cref="T1"/> to <see cref="AnyOf{T1, T2, TRoot}"/>.
        /// </summary>
        /// <param name="value">The value.</param>
        /// <returns>
        /// The result of the conversion.
        ...
        /// <summary>
        /// Performs an implicit conversion from <see cref="T2"/> to <see cref="AnyOf{T1, T2, TRoot}"/>.
        /// </summary>
        /// <param name="value">The value.</param>
        /// <returns>
        /// The result of the conversion.
    ...
    public class Any<T1, T2, T3>
    {
        ...
        /// <summary>
        /// Performs an implicit conversion from <see cref="T1"/> to <see cref="Any{T1, T2, T3}"/>.
        /// </summary>
        /// <param name="value">The value.</param>
        /// <returns>
        /// The result of the conversion.
        ...
        /// <summary>
        /// Performs an implicit conversion from <see cref="T2"/> to <see cref="Any{T1, T2, T3}"/>.
        /// </summary>
        /// <param name="value">The value.</param>
        /// <returns>
        /// The result of the conversion.
        ...
        /// <summary>
        /// Performs an implicit conversion from <see cref="T3"/> to <see cref="Any{T1, T2, T3}"/>.
        /// </summary>
        /// <param name="value">The value.</param>
        /// <returns>
        /// The result of the conversion.
    ...
    public class Any<T1, T2, T3, T4>
    {
        ...
        /// <summary>
        /// Performs an implicit conversion from <see cref="T1"/> to <see cref="Any{T1, T2, T3, T4}"/>.
        /// </summary>
        /// <param name="value">The value.</param>
        /// <returns>
        /// The result of the conversion.
        ...
        /// <summary>
        /// Performs an implicit conversion from <see cref="T2"/> to <see cref="Any{T1, T2, T3, T4}"/>.
        /// </summary>
        /// <param name="value">The value.</param>
        /// <returns>
        /// The result of the conversion.
        ...
        /// <summary>
        /// Performs an implicit conversion from <see cref="T3"/> to <see cref="Any{T1, T2, T3, T4}"/>.
        /// </summary>
        /// <param name="value">The value.</param>
        /// <returns>
        /// The result of the conversion.
        ...
        /// <summary>
        /// Performs an implicit conversion from <see cref="T4"/> to <see cref="Any{T1, T2, T3, T4}"/>.
        /// </summary>
        /// <param name="value">The value.</param>
        /// <returns>
        /// The result of the conversion.
